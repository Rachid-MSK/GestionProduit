package org.sid.produits.security;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
	...
	auth.inMemoryAuthentication().withUser("agent").password(passwordEncoder.encode("123")).roles("AGENT","USER");
    ...
    */
	...
	@Override
	 protected void configure(HttpSecurity http) throws Exception {
		 ...
		 http.authorizeRequests().antMatchers("/saveProduit").hasAnyAuthority("ADMIN","AGENT");
		 http.authorizeRequests().antMatchers("/ListProduits").hasAnyAuthority("ADMIN","AGENT","USER");
